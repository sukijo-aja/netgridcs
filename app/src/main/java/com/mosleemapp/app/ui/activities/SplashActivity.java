...
import com.mosleemapp.app.data.remote.services.VersionApiService;
...
public class SplashActivity extends AppCompatActivity {
    ...
    private void fetchVersion() {
        com.mosleemapp.app.data.repository.VersionRepository repository = new com.mosleemapp.app.data.repository.VersionRepository();
        repository.checkAndSyncVersion(this, new com.mosleemapp.app.data.repository.VersionRepository.VersionCallback() {
            @Override
